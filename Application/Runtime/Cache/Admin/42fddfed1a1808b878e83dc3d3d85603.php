            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>广告浏览</span>
                    </div>
                        ...
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    ...
                                    <td><img src="/jd/Public/Uploads/Advance/m_<?php echo ($vo["img"]); ?>" /></td>
                                    <td><?php echo ($vo["links"]); ?></td>
                                    <td>
                                        <?php switch($vo['location']): case "0": ?>首页<?php break;?>
                                            <?php case "1": ?>二级页<?php break;?>
                                            <?php default: ?>没有值<?php endswitch;?>
                                    </td>
                                    <td>
                                        <?php switch($vo['status']): case "0": ?>显示<?php break;?>
                                            <?php case "1": ?>不显示<?php break;?>
                                            <?php default: ?>没有值<?php endswitch;?>
                                    </td>
                                    <td><?php echo ($vo["seriation"]); ?></td>
                                    <td><?php echo (date("Y-m-d",$vo["addtime"])); ?></td>
                                    <td>
                                        <a href="<?php echo U('Advance/advanceEdit',array('advanceId'=>$vo['advanceId']));?>"><button type="button" class="btn" >修改</button></a>
                                        <a href="<?php echo U('Advance/advanceDel',array('advanceId'=>$vo['advanceId']));?>"><button type="button" class="btn" >删除</button></a>
                                    </td>
