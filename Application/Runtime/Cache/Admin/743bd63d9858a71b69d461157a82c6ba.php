                        ...
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    ...
                                    <td><?php echo ($vo['audit'] == 1?'已审核':'未审核'); ?></td>
                                    <td><?php echo ($vo['status'] == 1?'显示':'不显示'); ?></td>
                                    <td><?php echo ($vo["seriation"]); ?></td>
                                    <td><?php echo ($vo["webmaster"]); ?></td>
                                    <td>
                                        <a href="<?php echo U('Link/editLink',array('linkId'=>$vo['linkId']));?>"><button type="button" class="btn" >修改</button></a>
                                        <a href="<?php echo U('Link/delLink',array('linkId'=>$vo['linkId']));?>"><button type="button" class="btn" >删除</button></a>
                                    </td>
